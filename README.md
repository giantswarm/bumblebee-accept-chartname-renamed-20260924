[![CircleCI](https://dl.circleci.com/status-badge/img/gh/giantswarm/bumblebee-accept-chartname-20260924/tree/main.svg?style=svg)](https://dl.circleci.com/status-badge/redirect/gh/giantswarm/bumblebee-accept-chartname-20260924/tree/main)
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/giantswarm/bumblebee-accept-chartname-20260924/badge)](https://securityscorecards.dev/viewer/?uri=github.com/giantswarm/bumblebee-accept-chartname-20260924)
...
placeholders below, renames the chart directory `helm/bumblebee-accept-chartname-20260924` and pushes the result as the first commit. When
copying by hand, rename the chart directory and replace them yourself
(`devctl replace -i 'bumblebee-accept-chartname-20260924' <name> --ignore '.git/**' '**'`, likewise for the other two).

| Placeholder | Where | Replaced with |
|---|---|---|
| `bumblebee-accept-chartname-20260924` | the chart directory `helm/bumblebee-accept-chartname-20260924`, `Chart.yaml`, `values.yaml`, `.abs/main.yaml`, `CHANGELOG.md`, this README | the repository name |
...
| `https://github.com/giantswarm/bumblebee-accept-chartname-20260924` | this README | the upstream Helm repository the chart is based on |
...
is created from either template the same way; only when copying by hand does the pattern differ (`bumblebee-accept-chartname-20260924`
...
# bumblebee-accept-chartname-20260924 chart

Giant Swarm offers a bumblebee-accept-chartname-20260924 App which can be installed in workload clusters.
Here, we define the bumblebee-accept-chartname-20260924 chart with its templates and default configuration.
...
- https://github.com/giantswarm/bumblebee-accept-chartname-20260924
